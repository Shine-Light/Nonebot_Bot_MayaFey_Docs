...
<h4 id="新增-更加便利的matcher级别权限控制" tabindex="-1"><a class="header-anchor" href="#新增-更加便利的matcher级别权限控制" aria-hidden="true">#</a> 新增 更加便利的matcher级别权限控制</h4>
<h4 id="新增-增加权限自定义" tabindex="-1"><a class="header-anchor" href="#新增-增加权限自定义" aria-hidden="true">#</a> 新增 增加权限自定义</h4>
<h4 id="更新-娱乐功能-原神祈愿支持3-5" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-原神祈愿支持3-5" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 原神祈愿支持3.5</h4>
<h4 id="更新-娱乐功能-今日运势更新至最新版本" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-今日运势更新至最新版本" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 今日运势更新至最新版本</h4>
<h4 id="更新-管理功能-重写-ban-word" tabindex="-1"><a class="header-anchor" href="#更新-管理功能-重写-ban-word" aria-hidden="true">#</a> 更新 管理功能 -&gt; 重写 ban_word</h4>
<h4 id="修改-问答配置输出使用格式化" tabindex="-1"><a class="header-anchor" href="#修改-问答配置输出使用格式化" aria-hidden="true">#</a> 修改 问答配置输出使用格式化</h4>
<h4 id="修改-修改日志记录方式" tabindex="-1"><a class="header-anchor" href="#修改-修改日志记录方式" aria-hidden="true">#</a> 修改 修改日志记录方式</h4>
<h4 id="修复-管理功能-自定义问答-修复问答回答只识别最后一个字符" tabindex="-1"><a class="header-anchor" href="#修复-管理功能-自定义问答-修复问答回答只识别最后一个字符" aria-hidden="true">#</a> 修复 管理功能 -&gt; 自定义问答 修复问答回答只识别最后一个字符</h4>
<h4 id="修复-管理功能-自定义问答-修复问答添加问题错误" tabindex="-1"><a class="header-anchor" href="#修复-管理功能-自定义问答-修复问答添加问题错误" aria-hidden="true">#</a> 修复 管理功能 -&gt; 自定义问答 修复问答添加问题错误</h4>
<h4 id="修复-管理功能-自定义问答-修复问答匹配无法换行文字" tabindex="-1"><a class="header-anchor" href="#修复-管理功能-自定义问答-修复问答匹配无法换行文字" aria-hidden="true">#</a> 修复 管理功能 -&gt; 自定义问答 修复问答匹配无法换行文字</h4>
<h4 id="修复-管理功能-自定义问答-修复正则问答列表显示错误" tabindex="-1"><a class="header-anchor" href="#修复-管理功能-自定义问答-修复正则问答列表显示错误" aria-hidden="true">#</a> 修复 管理功能 -&gt; 自定义问答  修复正则问答列表显示错误</h4>
<h4 id="修复-管理功能-群管-修复群管错误" tabindex="-1"><a class="header-anchor" href="#修复-管理功能-群管-修复群管错误" aria-hidden="true">#</a> 修复 管理功能 -&gt; 群管 修复群管错误</h4>
<h4 id="修复-管理功能-更新-修复更新错误不会中断对话" tabindex="-1"><a class="header-anchor" href="#修复-管理功能-更新-修复更新错误不会中断对话" aria-hidden="true">#</a> 修复 管理功能 -&gt; 更新 修复更新错误不会中断对话</h4>
<h4 id="修复-被动功能-复读机-修复复读错误" tabindex="-1"><a class="header-anchor" href="#修复-被动功能-复读机-修复复读错误" aria-hidden="true">#</a> 修复 被动功能 -&gt; 复读机 修复复读错误</h4>
<h4 id="修复-被动功能-复读机-修复复读会复读命令信息" tabindex="-1"><a class="header-anchor" href="#修复-被动功能-复读机-修复复读会复读命令信息" aria-hidden="true">#</a> 修复 被动功能 -&gt; 复读机 修复复读会复读命令信息</h4>
<h4 id="修复-修复机器人重连后报错" tabindex="-1"><a class="header-anchor" href="#修复-修复机器人重连后报错" aria-hidden="true">#</a> 修复 修复机器人重连后报错</h4>
...
<h4 id="移除-删除无用代码-1" tabindex="-1"><a class="header-anchor" href="#移除-删除无用代码-1" aria-hidden="true">#</a> 移除 删除无用代码</h4>
...
<h4 id="更新-娱乐功能-模拟原神祈愿-蛋池详情角色名称跟随属性变化" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-模拟原神祈愿-蛋池详情角色名称跟随属性变化" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 模拟原神祈愿 蛋池详情角色名称跟随属性变化</h4>
<h4 id="更新-娱乐功能-表情包制作-更新至最新版本" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-表情包制作-更新至最新版本" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 表情包制作 更新至最新版本</h4>
<h4 id="更新-娱乐功能-头像表情包制作-更新至最新版本" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-头像表情包制作-更新至最新版本" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 头像表情包制作 更新至最新版本</h4>
<h4 id="更新-娱乐功能-点歌台-更新至最新版本" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-点歌台-更新至最新版本" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 点歌台 更新至最新版本</h4>
<h4 id="更新-娱乐功能-原神角色展柜-更新至最新版本" tabindex="-1"><a class="header-anchor" href="#更新-娱乐功能-原神角色展柜-更新至最新版本" aria-hidden="true">#</a> 更新 娱乐功能 -&gt; 原神角色展柜 更新至最新版本</h4>
<h4 id="更新-管理功能-更新-更新前增加确认提示" tabindex="-1"><a class="header-anchor" href="#更新-管理功能-更新-更新前增加确认提示" aria-hidden="true">#</a> 更新 管理功能 -&gt; 更新 更新前增加确认提示</h4>
<h4 id="更新-被动功能-权限控制-权限不足添加对应插件名提示" tabindex="-1"><a class="header-anchor" href="#更新-被动功能-权限控制-权限不足添加对应插件名提示" aria-hidden="true">#</a> 更新 被动功能 -&gt; 权限控制 权限不足添加对应插件名提示</h4>
<h4 id="更新-管理功能-退-踢出群提示-追加转义字符" tabindex="-1"><a class="header-anchor" href="#更新-管理功能-退-踢出群提示-追加转义字符" aria-hidden="true">#</a> 更新 管理功能 -&gt; 退/踢出群提示 追加转义字符</h4>
<h4 id="更新-适配nonebot2-2-0-0rc2" tabindex="-1"><a class="header-anchor" href="#更新-适配nonebot2-2-0-0rc2" aria-hidden="true">#</a> 更新 适配nonebot2 2.0.0rc2</h4>
<h4 id="修改-被动功能-防白嫖-被踢出不视为白嫖" tabindex="-1"><a class="header-anchor" href="#修改-被动功能-防白嫖-被踢出不视为白嫖" aria-hidden="true">#</a> 修改 被动功能 -&gt; 防白嫖 被踢出不视为白嫖</h4>
<h4 id="修改-娱乐功能-ai聊天-移除图灵接口" tabindex="-1"><a class="header-anchor" href="#修改-娱乐功能-ai聊天-移除图灵接口" aria-hidden="true">#</a> 修改 娱乐功能 -&gt; AI聊天 移除图灵接口</h4>
<h4 id="修改-使用ujson代替json" tabindex="-1"><a class="header-anchor" href="#修改-使用ujson代替json" aria-hidden="true">#</a> 修改 使用ujson代替json</h4>
<h4 id="修改-获取群成员信息不使用缓存" tabindex="-1"><a class="header-anchor" href="#修改-获取群成员信息不使用缓存" aria-hidden="true">#</a> 修改 获取群成员信息不使用缓存</h4>
<h4 id="修改-htmlrender以依赖形式加载" tabindex="-1"><a class="header-anchor" href="#修改-htmlrender以依赖形式加载" aria-hidden="true">#</a> 修改 htmlrender以依赖形式加载</h4>
...
<h4 id="本次更新需要在github下载并替换以下文件夹" tabindex="-1"><a class="header-anchor" href="#本次更新需要在github下载并替换以下文件夹" aria-hidden="true">#</a> 本次更新需要在Github下载并替换以下文件夹</h4>
<ol>
<li>resource/img</li>
<li>resource/font</li>
</ol>
...
<h5 id="新增-nonebot-plugin-imageutils" tabindex="-1"><a class="header-anchor" href="#新增-nonebot-plugin-imageutils" aria-hidden="true">#</a> 新增 nonebot_plugin_imageutils</h5>
...
<h4 id="更新-天气更新到最新版本" tabindex="-1"><a class="header-anchor" href="#更新-天气更新到最新版本" aria-hidden="true">#</a> 更新 天气更新到最新版本</h4>
...
<li>baidu_image_secret</li>
<li>baidu_image_level</li>
</ol>
...
<h4 id="新增-ai对话" tabindex="-1"><a class="header-anchor" href="#新增-ai对话" aria-hidden="true">#</a> 新增 AI对话</h4>
<h4 id="新增-插件帮助" tabindex="-1"><a class="header-anchor" href="#新增-插件帮助" aria-hidden="true">#</a> 新增 插件帮助</h4>
<h4 id="修复-每日运势已知问题" tabindex="-1"><a class="header-anchor" href="#修复-每日运势已知问题" aria-hidden="true">#</a> 修复 每日运势已知问题</h4>
...
<h4 id="添加管理员私聊管理功能" tabindex="-1"><a class="header-anchor" href="#添加管理员私聊管理功能" aria-hidden="true">#</a> 添加管理员私聊管理功能</h4>
<h4 id="添加好友自接受" tabindex="-1"><a class="header-anchor" href="#添加好友自接受" aria-hidden="true">#</a> 添加好友自接受</h4>
<h4 id="添加到账语音生成" tabindex="-1"><a class="header-anchor" href="#添加到账语音生成" aria-hidden="true">#</a> 添加到账语音生成</h4>
<h4 id="修复已知问题" tabindex="-1"><a class="header-anchor" href="#修复已知问题" aria-hidden="true">#</a> 修复已知问题</h4>
<h2 id="_0-3版本更新日志-2022-5-3" tabindex="-1"><a class="header-anchor" href="#_0-3版本更新日志-2022-5-3" aria-hidden="true">#</a> 0.3版本更新日志 2022/5/3</h2>
<h4 id="添加21点游戏" tabindex="-1"><a class="header-anchor" href="#添加21点游戏" aria-hidden="true">#</a> 添加21点游戏</h4>
<h4 id="添加epic限免资讯" tabindex="-1"><a class="header-anchor" href="#添加epic限免资讯" aria-hidden="true">#</a> 添加Epic限免资讯</h4>
<h4 id="添加答案之书" tabindex="-1"><a class="header-anchor" href="#添加答案之书" aria-hidden="true">#</a> 添加答案之书</h4>
<h4 id="修复已知问题-1" tabindex="-1"><a class="header-anchor" href="#修复已知问题-1" aria-hidden="true">#</a> 修复已知问题</h4>
<h2 id="_0-2版本更新日志-2022-4-21" tabindex="-1"><a class="header-anchor" href="#_0-2版本更新日志-2022-4-21" aria-hidden="true">#</a> 0.2版本更新日志 2022/4/21</h2>
<h4 id="添加俄罗斯轮盘游戏" tabindex="-1"><a class="header-anchor" href="#添加俄罗斯轮盘游戏" aria-hidden="true">#</a> 添加俄罗斯轮盘游戏</h4>
<h4 id="添加logo制作" tabindex="-1"><a class="header-anchor" href="#添加logo制作" aria-hidden="true">#</a> 添加logo制作</h4>
<h4 id="添加表情包制作" tabindex="-1"><a class="header-anchor" href="#添加表情包制作" aria-hidden="true">#</a> 添加表情包制作</h4>
