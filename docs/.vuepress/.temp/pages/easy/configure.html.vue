...
<ol>
<li>进入<a href="https://cloud.tencent.com" target="_blank" rel="noopener noreferrer">腾讯云官网<ExternalLinkIcon/></a></li>
...
<h3 id="天行数据热搜api-可选" tabindex="-1"><a class="header-anchor" href="#天行数据热搜api-可选" aria-hidden="true">#</a> 天行数据热搜API(可选)</h3>
<div class="custom-container tip"><p class="custom-container-title">提示</p>
<p>该接口每日100次免费调用额度</p>
</div>
...
<h4 id="ai-talk-tianx-mode" tabindex="-1"><a class="header-anchor" href="#ai-talk-tianx-mode" aria-hidden="true">#</a> ai_talk_tianx_mode</h4>
...
<p>说明: 最大允许违规次数,违规达到次数时将踢出并拉黑<br>
...
<h4 id="ban-rand-time-min" tabindex="-1"><a class="header-anchor" href="#ban-rand-time-min" aria-hidden="true">#</a> BAN_RAND_TIME_MIN</h4>
<p>说明: 随机禁言最小时间</p>
<h4 id="ban-rand-timr-max" tabindex="-1"><a class="header-anchor" href="#ban-rand-timr-max" aria-hidden="true">#</a> BAN_RAND_TIMR_MAX</h4>
<p>说明: 随机禁言最大时间</p>
