...
|功能|命令|权限|
|-|-|-|
|禁言|`/禁 {@xx} {@xx} ... {时间}`|**超级用户及以上**|
|解禁|`/解 {@xx} {@xx} ...`|**超级用户及以上**|
|踢出|`/踢 {@xx} {@xx} ...`|**超级用户及以上**|
|拉黑|`/黑 {@xx} {@xx} ...`|**超级用户及以上**|
|全员禁言|`/禁言全员 {@xx} {@xx} ...`|**超级用户及以上**|
|解除全员禁言|`/解禁全员 {@xx} {@xx} ...`|**超级用户及以上**|
|设置头衔|`/设置头衔 {@xx} {@xx} ... {头衔}`|**超级用户及以上**|
|取消头衔|`/取消头衔 {@xx} {@xx} ... {头衔}`|**超级用户及以上**|
|添加管理员|`/管理员+ {@xx} {@xx} ...`|**根用户**|
|取消管理员|`/管理员+ {@xx} {@xx} ...`|**根用户**|
...
|命令|功能|备注|
|-|-|-|
|`/发送 {群号}`|发送信息到指定群内,支持CQ码|群号可用`all`表示所有开启机器人的群|
|`/显示发送者`|发送信息时显示发送者昵称||
|`/隐藏发送者`|发送信息时隐藏发送者昵称||
...
## 被动功能
### cd
插件触发次数及时间限制, 可在 `config/cd/群号/cd.json` 中配置, 配置项可参考[插件标准](../develop/standard.md#cd)
